...
export default function Roadmap() {
  ...
  return (
    <section id="roadmap" className="bg-darkmode py-28 text-center text-white relative overflow-hidden">
      <div className="container mx-auto px-6 md:max-w-6xl relative">
        {/* Garis Horizontal Utama (di belakang semua diamond) */}
        <div className="absolute top-[10.6rem] left-1/2 -translate-x-1/2 w-[90%] max-w-6xl border-t border-dashed border-gray-500 z-0"></div>
